...
export default function UpdatePicoPlacaForm() {
	...
	// Estados para cada tipo de vehículo
					...
					<form
						...
						<div className="flex justify-center">
							<button
								...
								type="submit"
								className="px-6 py-3 bg-indigo-500 dark:bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-600 dark:hover:bg-indigo-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2">
								Guardar
							</button>
						</div>
					</form>
